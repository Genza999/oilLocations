    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            case R.id.car_repair:
                ...
                Toast.makeText(MapsActivity.this, "Showing Nearby garage's", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.gas_station:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this, "Showing Petrol stations", Toast.LENGTH_SHORT).show();
                break;
            case R.id.train_station:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this, "Showing Nearby Train stations", Toast.LENGTH_SHORT).show();
                break;
        }
    }
